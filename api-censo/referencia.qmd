...
| hog          | ID_RESIDENCIA_N4    | Distrito                                                                 | District                                                         |
| hog          | ID_RESIDENCIA_N5    | Sección                                                                  | Section                                                          |
...
| nuc          | ID_RESIDENCIA_N4        | Distrito                                         | District                                                 |
| nuc          | ID_RESIDENCIA_N5        | Sección                                          | Section                                                  |
...
| per.estu     | ID_RESIDENCIA_N4    | Distrito                                                | District                                                          |
| per.estu     | ID_RESIDENCIA_N5    | Sección                                                 | Section                                                           |
...
| per.ocu      | ID_RESIDENCIA_N4         | Distrito                                                                  | District                                                               |
| per.ocu      | ID_RESIDENCIA_N5         | Sección                                                                   | Section                                                                |
...
| per.ppal     | ID_RESIDENCIA_N4    | Distrito                                                | District                                                          |
| per.ppal     | ID_RESIDENCIA_N5    | Sección                                                 | Section                                                           |
...
| viv.fam      | ID_RESIDENCIA_N4       | Distrito                                      | District                                                 |
| viv.fam      | ID_RESIDENCIA_N5       | Sección                                       | Section                                                  |
...
| viv.ppal     | ID_RESIDENCIA_N4    | Distrito                                                | District                                                          |
| viv.ppal     | ID_RESIDENCIA_N5    | Sección                                                 | Section                                                           |
